 ...
 * هرگز service_role key را داخل این فایل قرار ندهید.
 * ================================================================
 */
...
const HOKM_SUPABASE_CONFIG = {
    ...
    /*
     * مسیر صفحه‌ای که بعد از بازیابی رمز
     * کاربر به آن برمی‌گردد.
     */
...
const HOKM_GAME_CONFIG = {
    ...
    /*
     * حداکثر تعداد کارت‌های هر بازیکن
     */
    ...
    /*
     * تعداد امتیاز لازم برای پایان مسابقه
     */
...
function createHokmSupabaseClient() {
    ...
    /*
     * اگر Client قبلاً ساخته شده،
     * همان Client را استفاده می‌کنیم.
     */
    ...
    /*
     * کتابخانه Supabase باید قبل از این فایل
     * در HTML بارگذاری شده باشد.
     */
...
(function initializeHokmConfig() {
    ...
    /*
     * اگر Supabase library قبلاً آمده باشد،
     * Client را همین حالا می‌سازیم.
     */
