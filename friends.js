...
/*
 * نام اصلی جدول دوستان.
 *
 * اگر database.sql شما از friendship استفاده کرده باشد،
 * این فایل در زمان اجرا آن را نیز امتحان می‌کند.
 */
...
async function loadFriends(
    ...
    try {
        ...
        if (
            ...
            /*
             * نسخه جایگزین برای جدول‌هایی که
             * sender_id / receiver_id دارند.
             */
...
async function sendFriendRequest(
    ...
    try {
        ...
        /*
         * اگر جدول از user_id / friend_id استفاده کند.
         */
...
async function acceptFriendRequest(
    ...
    try {
        ...
        /*
         * fallback برای ساختار user_id / friend_id
         */
...
async function loadOnlineFriends() {
    ...
    /*
     * سیستم حضور واقعی در multiplayer.js یا Supabase Realtime
     * می‌تواند وضعیت presence را به این لیست اضافه کند.
     *
     * اگر Presence آماده نباشد، دوستان را آفلاین در نظر می‌گیریم.
     */
...
async function inviteFriendToRoom(
    ...
    /*
     * ابتدا Room فعلی را پیدا می‌کنیم.
     */
            ...
            if (
                ...
                container.innerHTML = `
                    <div class="friends-empty">
                        ...
                        <div class="friends-empty-title">
                            هنوز دوستی اضافه نکرده‌ای
                        </div>
                        <div class="friends-empty-text">
                            بازیکنان مورد علاقه‌ات را پیدا کن و برای بازی دعوتشان کن.
                        </div>
                    </div>
                `;
...
function createFriendElement(
    ...
    wrapper.innerHTML = `
        <div class="friend-avatar-wrap">
            ...
            <span
                class="friend-online-dot ${online ? "online" : "offline"}"
            ></span>
        </div>
        ...
        <div class="friend-actions">
            ...
            <button
                type="button"
                class="friend-action-btn friend-play-btn"
    ...
    wrapper.innerHTML = `
        ...
        <div class="friend-info">
            ...
            <div class="friend-meta">
                سطح
                ${Number(profile.level || 1).toLocaleString("fa-IR")}
            </div>
...
async function initializeFriends() {
    ...
    if (!user) {
        ...
        /*
         * Auth ممکن است هنوز آماده نشده باشد.
         */
