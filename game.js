...
function joinRoom() {
     ...
     * نسخه فعلی محلی است.
     *
     * در نسخه آنلاین واقعی،
     * اینجا کد اتاق در Supabase
     * جست‌وجو خواهد شد.
     */
...
function startGame() {
    ...
    setTimeout(
        () => {
            ...
            /*
             * در حکم، برای نسخه آزمایشی
             * بازیکن محلی حاکم در نظر گرفته می‌شود.
             */
...
function initializeHands() {
    ...
    /*
     * برای نسخه آزمایشی
     * 13 کارت به هر بازیکن داده می‌شود.
     */
...
function setTrumpSuit(suit) {
    ...
    /*
     * اگر نوبت بازیکن محلی نباشد،
     * شبیه‌سازی بازیکن‌های دیگر آغاز می‌شود.
     */
...
function getPlayableCards(playerId) {
     ...
     * قانون اصلی حکم:
     *
     * اگر بازیکن خال شروع‌شده را دارد،
    ...
    /*
     * اگر آن خال را ندارد،
     * می‌تواند هر کارت دیگری بازی کند.
     */
...
function playCard(
    ...
    /*
     * چهار کارت که بازی شدند،
     * برنده دست مشخص می‌شود.
     */
...
function chooseComputerCard(
    ...
    /*
     * هوش مصنوعی نسخه اول ساده است.
     *
     * بعداً می‌توانیم یک AI بسیار قوی‌تر
     * برای حکم اضافه کنیم.
     */
    ...
    /*
     * اگر امکان بازی حکم وجود داشته باشد،
     * گاهی یک کارت حکم کم‌ارزش را انتخاب می‌کنیم.
     */
    ...
    /*
     * در حالت عادی پایین‌ترین کارت قانونی
     * انتخاب می‌شود.
     */
...
function resolveTrick() {
    ...
    setTimeout(
        () => {
            ...
            /*
             * اگر یکی از تیم‌ها ۷ دست برده باشد،
             * راند تمام شده است.
             */
...
function cardBeats(
    ...
    /*
     * حکم همیشه بالاتر از خال عادی است.
     */
    ...
    /*
     * اگر کارت فعلی حکم نیست
     * ولی کارت چالشگر هم حکم نیست،
     * فقط کارت خال شروع‌شده می‌تواند برنده شود.
     */
    ...
    /*
     * اگر هر دو از خال شروع‌شده هستند،
     * رتبه بالاتر برنده است.
     */
...
function buyShopItem(
    ...
    /*
     * آیتم‌های فروشگاه در این نسخه
     * فقط آیتم‌های تزئینی هستند.
     */
...
function quickPlay() {
    ...
    /*
     * فعلاً بازی سریع یک اتاق محلی آزمایشی
     * ایجاد می‌کند.
     */
    ...
    /*
     * چون نسخه آزمایشی است،
     * چهار بازیکن شبیه‌سازی شده‌اند.
     */
